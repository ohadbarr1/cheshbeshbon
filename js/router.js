...
const Router = {
    ...
    meta: {
        home: {
            ...
            description: 'חשבשבון — כלי חכם לחישוב משכנתא, שכר נטו, שכירות מול קנייה, פנסיה ומס עצמאים. 5 מחשבונים מקצועיים, נתוני 2026, חינם ובלי הרשמה.'
        },
        calculators: {
            title: 'מחשבונים פיננסיים — חשבשבון',
            description: '5 מחשבונים פיננסיים מקצועיים: משכנתא, שכר נטו, שכירות מול קנייה, פנסיה ומס עצמאים. נתוני 2026.'
        },
        mortgage: {
        ...
        about: {
            ...
            description: 'איך חשבשבון עובד: 5 מחשבונים פיננסיים בזמן אמת, נתוני 2026, בלי הרשמה.'
        },
        faq: {
